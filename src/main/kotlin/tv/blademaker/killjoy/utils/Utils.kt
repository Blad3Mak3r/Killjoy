...
object Utils {
    ...
    fun printBanner(logger: Logger, isMaster: Boolean, pid: Long) {
        logger.info("""Starting in ${if (isMaster) "Master" else "Worker"} mode with PID $pid
            ___  ___ ___  __    ___  ___       ___             ___  ________      ___    ___ ___  ___    
           /  /|/  /|\  \|\  \ |\  \|\  \     |\  \           |\  \|\   __  \    |\  \  /  /|\  \|\  \   
          /  / /  / | \  \/  /|\ \  \ \  \    \ \  \          \ \  \ \  \|\  \   \ \  \/  / | \  \ \  \  
         /  / /  / / \ \   ___  \ \  \ \  \    \ \  \       __ \ \  \ \  \\\  \   \ \    / / \ \  \ \  \ 
        |\  \/\  \/   \ \  \\ \  \ \  \ \  \____\ \  \____ |\  \\_\  \ \  \\\  \   \/  /  /   \/  /\/  /|
        \ \  \ \  \    \ \__\\ \__\ \__\ \_______\ \_______\ \________\ \_______\__/  / /     /  ///  // 
         \ \__\ \__\    \|__| \|__|\|__|\|_______|\|_______|\|________|\|_______|\___/ /     /_ ///_ //  
          \|__|\|__|                                                            \|___|/     |__|/|__|/  
    """.trimIndent())
    }
